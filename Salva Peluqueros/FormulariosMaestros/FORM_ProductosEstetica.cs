...
{
    public partial class FORM_ProductosEstetica : Form
    {


        public FORM_ProductosEstetica()
        {
            InitializeComponent();
        ...
        string carpetafotos = "Fotos de productos estetica";

        //DB
        OleDbConnection Conexion;
        
        string tabla = "ProductosEstetica";
       ...
       // int numerocerosaizquierda = 6;
        ...
        #region Esqueleto
        private void FORM_ProductosEstetica_Load(object sender, EventArgs e)
        {
      ...
      //      codcurso.CambiarNombreTextBoxComoControl();
        ...
        private void FORM_ProductosEstetica_FormClosing(object sender, FormClosingEventArgs e)
        {
